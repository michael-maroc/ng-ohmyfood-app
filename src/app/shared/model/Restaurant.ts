export const Restaurant = [
  {
    ...
    dishes: [
      ...
      {
        title: 'Parmentier de queue de bœuf',
        description: 'A la truffe noire sur sa purée de panais',
        price: 35,
      },
      {
  ...
  {
    id: 2,
    cover: '../../assets/images/restaurants/stil-u2Lp8tXIcjw-unsplash.jpg',
